...
var splashes = [
  ...
  "Maker of the Lagtrain Fitbit clockface",
  "Don't buy a HMD/Nokia phone. You can't unlock the bootloader :(",
  "Eternally 14",
  "Collecting mental illnesses like Pokemon since 2008",
  "Leader of Miku and More!",
  "Maker of Dhilly Game!",
  "Maker of Ice OS!",
  "Many things are temporary, but INTERVALS is eternal",
  ...
  "DIY or die!!",
  '<a href="https://hackclub.com/">Hack Club</a> is awesome!',
  ...
  "<a href='https://www.youtube.com/watch?v=iZ_P3F3nA1U&pp=ygUKY2FibmV0IG1hbg%3D%3D'>You can't see me behind the screen - I'm half human and half machine!</a>",
...
function createAd() {
  var ads = ["3d.png", "bfdionyowrist.png", "eveplaylist4.png", "iceos.png", "dhillygamead.png", "hfjone_whtthefuck.png"];
  ...
  var adlinks = [
    ...
    "https://open.spotify.com/playlist/6XV9M0tU7RTCf7mH40FrXd?si=kkOtTEzOQTKHcECNymaL5A",
    "/iceos",
