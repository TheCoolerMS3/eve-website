...
catch { // Funny message that displays only for people with severely outdated browsers
  document.getElementById("splash").innerHTML = "Your browser is cooked bro please update it";
}
function discord() {
